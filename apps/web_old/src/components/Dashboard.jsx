...
export default function Dashboard() {
  // Dados mockados de termos mais buscados
  // 1. Termos mais buscados (Barra)
  ...
  // 3. Percentual por categoria (Pie)
  ...
  // 4. Taxa de sucesso das buscas (Doughnut)
  const dataSuccess = {
  ...
  // 5. Distribuição por dia da semana (Radar)
    ...
    <div className="pt-4" style={{ width: '100%', minHeight: '100vh', margin: 0, padding: 0 }}>
      <div style={{ width: '100%', margin: 0, padding: 0 }}>
        <div style={{ width: '100%' }}>
          ...
          <div className="row">
            {/* Barras: termos mais buscados */}
            <div className="col-12 mb-4">
              <div className="card card-info card-outline w-100" style={{ margin: 0, padding: 0 }}>
                <div className="card-body" style={{ padding: 0 }}>
                  <div style={{ width: '100%', height: 320 }}>
                    <Bar data={dataTech} options={{...options, plugins: { ...options.plugins, title: { ...options.plugins.title, text: 'Termos mais buscados (Barra)' } }, maintainAspectRatio: false}} />
                  </div>
                </div>
              </div>
            </div>
            {/* Linha: buscas por horário */}
            <div className="col-12 mb-4">
              <div className="card card-success card-outline w-100" style={{ margin: 0, padding: 0 }}>
                <div className="card-body" style={{ padding: 0 }}>
                  <div style={{ width: '100%', height: 320 }}>
                    <Line data={dataHour} options={{...options, plugins: { ...options.plugins, title: { ...options.plugins.title, text: 'Buscas por horário (Linha)' } }, maintainAspectRatio: false, scales: { y: { beginAtZero: true } }}} />
                  </div>
                </div>
              </div>
            </div>
            {/* Pizza: percentual por categoria */}
            <div className="col-12 mb-4">
              <div className="card card-warning card-outline w-100" style={{ margin: 0, padding: 0 }}>
                <div className="card-body" style={{ padding: 0 }}>
                  <div style={{ width: '100%', height: 320 }}>
                    <Pie data={dataCat} options={{...options, plugins: { ...options.plugins, title: { ...options.plugins.title, text: 'Percentual por categoria (Pizza)' } }, maintainAspectRatio: false}} />
                  </div>
                </div>
              </div>
            </div>
            {/* Doughnut: taxa de sucesso das buscas */}
            <div className="col-12 mb-4">
              <div className="card card-danger card-outline w-100" style={{ margin: 0, padding: 0 }}>
                <div className="card-body" style={{ padding: 0 }}>
                  <div style={{ width: '100%', height: 320 }}>
                    <Doughnut data={dataSuccess} options={{...options, plugins: { ...options.plugins, title: { ...options.plugins.title, text: 'Taxa de sucesso das buscas (Doughnut)' } }, maintainAspectRatio: false}} />
                  </div>
                </div>
              </div>
            </div>
            {/* Radar: distribuição por dia da semana */}
            <div className="col-12 mb-4">
              <div className="card card-secondary card-outline w-100" style={{ margin: 0, padding: 0 }}>
                <div className="card-body" style={{ padding: 0 }}>
                  <div style={{ width: '100%', height: 320 }}>
                    <Radar data={dataWeek} options={{...options, plugins: { ...options.plugins, title: { ...options.plugins.title, text: 'Distribuição por dia da semana (Radar)' } }, maintainAspectRatio: false, scales: { r: { beginAtZero: true } }}} />
                  </div>
                </div>
              </div>
            </div>
